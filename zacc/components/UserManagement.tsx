                            ...
                            {users.length === 0 ? (
                                ...
                                users.map((user) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <span
                                                className={`inline-block px-3 py-1 rounded-full text-xs font-bold border ${getRoleColor(user.role)}`}
                                            >
                                                {user.role}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="px-3 py-1 bg-blue-500/10 text-blue-400 rounded-lg text-xs font-bold hover:bg-blue-500/20 transition-all"
                                                >
                                                    Edit
                                                </button>
                                                <button
                                                    ...
                                                    className="px-3 py-1 bg-rose-500/10 text-rose-400 rounded-lg text-xs font-bold hover:bg-rose-500/20 transition-all"
                                                >
                                                    Delete
                                                </button>
                                            </div>
