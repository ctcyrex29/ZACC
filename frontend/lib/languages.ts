 ...
 * Zimbabwean languages are listed first for quick access.
 */
...
// Priority languages (Zimbabwe + regional) shown first
export const PRIORITY_LANGUAGES: LanguageEntry[] = [
  { code: "en", name: "English", nativeName: "English", region: "Zimbabwe" },
  { code: "sn", name: "Shona", nativeName: "chiShona", region: "Zimbabwe" },
  { code: "nd", name: "Ndebele", nativeName: "isiNdebele", region: "Zimbabwe" },
  { code: "to", name: "Tonga", nativeName: "chiTonga", region: "Zimbabwe" },
  { code: "ny", name: "Chewa/Nyanja", nativeName: "chiCheŵa", region: "Southern Africa" },
...
export const WORLD_LANGUAGES: LanguageEntry[] = [
...
/** All languages combined: priority first, then world languages (no duplicates) */
export const ALL_LANGUAGES: LanguageEntry[] = [
  ...PRIORITY_LANGUAGES,
  ...WORLD_LANGUAGES.filter(
    (w) => !PRIORITY_LANGUAGES.some((p) => p.code === w.code)
  ),
];
