...
import { WhistleblowerHub } from "./components/WhistleblowerHub";
...
const App: React.FC = () => {
    ...
    const getTitle = (view: View) => {
        switch (view) {
            ...
            case "report":
                return "Secure Submission";
            case "hub":
                return "Integrity Hub";
            case "chat":
        ...
        <div className="flex h-screen bg-[#04060b] font-sans text-slate-300 overflow-hidden">
            ...
            <main className="flex-1 overflow-y-auto px-6 py-8 md:px-12 md:py-16 scroll-smooth">
                <div className="max-w-7xl mx-auto">
                    ...
                    <footer className="mt-32 py-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-slate-700 text-[10px] font-black uppercase tracking-[0.2em]">
                        <div className="flex flex-col gap-1">
                            <p>© 2024 ZACC INTEGRITY NEXUS NODE 01.</p>
                            <p className="text-slate-800">
                                DATA TRANSMISSION IS AES-CRYPTED AND
                                NON-TRACEABLE.
                            </p>
                        </div>
                        <div className="flex gap-8 mt-6 md:mt-0">
                            <span className="flex items-center gap-2 text-nexus-emerald">
                                <div className="w-1.5 h-1.5 rounded-full bg-nexus-emerald shadow-[0_0_8px_rgba(16,185,129,0.8)]"></div>
                                SECURE ENDPOINT
                            </span>
                            <span>VER 5.0.4-STABLE</span>
                        </div>
                    </footer>
                </div>
            </main>
